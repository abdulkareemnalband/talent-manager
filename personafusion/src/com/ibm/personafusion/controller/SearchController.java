...
/**
 * Handles the GET /api/search endpoint. The controller for the Search
 * functionality. Requires 'fname' and 'lname' query parameters to search.
 * 
 * @author Sean Welleck
 **/
@Path("/search")
public class SearchController {
	...
	public static List<Person> people = Config.cc
			.getAllPeopleNotInGroup(Constants.CURRENT_EMPLOYEES_GROUP);
