...
public class NameGenerator {
	...
	// In the case we may need to distinguish gender. Highly unlikely, but just
	// in case.
	...
	/**
	 * This method generates a set of unique names (the amount depends on the
	 * parameter). It takes this set, outputs it in the output url that's been
	 * assigned in the class and returns the set.
	 *
	 * @param int peopleAmount - the number of unique full names you want to be
	 *        generated.
	 * @return A set of unique names. First and last names separately may not be
	 *         unique, but each entire/full name is.
	 */
